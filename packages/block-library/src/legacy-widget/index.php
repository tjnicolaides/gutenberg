...
function render_static_form( $attributes ) {
	ob_start();
	?>
<form method="post">	<div class="widget-content">				<input
				type="hidden"
				data-property="title"
				class="media-widget-instance-property"
				name="widget-media_gallery[2][title]"
				id="widget-media_gallery-2-title"
				value="wfdsfds3"
			/>
					<input
				type="hidden"
				data-property="ids"
				class="media-widget-instance-property"
				name="widget-media_gallery[2][ids]"
				id="widget-media_gallery-2-ids"
				value="21387,20701"
			/>
					<input
				type="hidden"
				...
				class="media-widget-instance-property"
				name="widget-media_gallery[2][columns]"
				id="widget-media_gallery-2-columns"
				value="3"
			/>
					<input
				type="hidden"
				data-property="size"
				class="media-widget-instance-property"
				name="widget-media_gallery[2][size]"
				id="widget-media_gallery-2-size"
				value="thumbnail"
			/>
					<input
				type="hidden"
				data-property="link_type"
				class="media-widget-instance-property"
				name="widget-media_gallery[2][link_type]"
				id="widget-media_gallery-2-link_type"
				value="post"
			/>
					<input
				type="hidden"
				data-property="orderby_random"
				class="media-widget-instance-property"
				name="widget-media_gallery[2][orderby_random]"
				id="widget-media_gallery-2-orderby_random"
				value=""
			/>
